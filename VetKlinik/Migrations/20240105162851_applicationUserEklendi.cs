    ...
    public partial class applicationUserEklendi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Gonderi", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelefonNumaralari = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailAdresleri = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Materyal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Materyal_Musteri_MusteriId",
                        column: x => x.MusteriId,
                        principalTable: "Musteri",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Materyal_Personel_PersonelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoruCevap", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SoruCevap_Musteri_MusteriId",
                        column: x => x.MusteriId,
                        principalTable: "Musteri",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SoruCevap_Personel_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "Personel",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materyal_MusteriId",
                table: "Materyal",
                column: "MusteriId");

            migrationBuilder.CreateIndex(
                name: "IX_Materyal_PersonelId",
                table: "Materyal",
                column: "PersonelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SoruCevap_MusteriId",
                table: "SoruCevap",
                column: "MusteriId");

            migrationBuilder.CreateIndex(
                name: "IX_SoruCevap_PersonelId",
                table: "SoruCevap",
                column: "PersonelId");
        }
